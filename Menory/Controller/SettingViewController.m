...
@property (strong, nonatomic) IBOutlet UIView *mainMyView;
...
- (void)viewDidLoad {
    ...
    [AllUtils setBackImage:self.mainMyView imageName:@"主页背景.png"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIImageView *cellImg = (UIImageView *)[cell viewWithTag:103];
